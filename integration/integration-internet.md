...
The split internet access is the simplest and relies on the native services in each of the two {{site.data.keyword.cloud_notm}} accounts. If you do not have your own {{site.data.keyword.cloud_notm}} account, the same principles for the RISE with SAP {{site.data.keyword.powerSys_notm}} setup applies. 
...
## Deployment option - single internet access point
